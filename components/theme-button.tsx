...
export function ModeToggle() {
  ...
  return (
    <Button
      ...
      className="fixed z-40 bottom-5 right-5 sm:bottom-10 sm:right-10 md:bottom-15 md:right-15 size-12 cursor-pointer border-2 hover:bg-accent hover:text-accent-foreground"
    >
